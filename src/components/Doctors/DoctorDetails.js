...
const DoctorDetails = () => {
  ...
  let [product] = useDoctors(productId);
  ...
  const handleOrder = (e) => {
    ...
    axios
      .post("https://wood-peckers.herokuapp.com/orders", newOrder)
      .then((res) => {
    ...
    axiosPrivate
      .put("https://digital-healthcare.onrender.com/doctors", updatedProduct)
      .then((res) => {
        //console.log(res.data);
      });
        ...
        <div className="row justify-content-between align-items-center ">
          ...
          <div className="col-md-6">
            ...
            <div className="py-1">
              <h5>
                Available Quantity:{" "}
                <span className="fw-bolder text-main">{product.stock}</span>
              </h5>
              <h5>
                Minimum Order Quantity:{" "}
                <span className="fw-bolder text-main">{product.minOrder}</span>
              </h5>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-6 p-5 pt-0 rounded-20 shadow bg-light-pro mb-5">
          ...
          <form onSubmit={handleOrder} className="mt-3">
            <div className="my-4">
              ...
              />
              {qunatityError && (
                <small className="text-danger text-ss">
            ...
            <button
              type="submit"
              className="mt-3 btn btn-dark d-inline-block"
              disabled={qunatityError}
            >
              Place Order <i className="ps-1 fas fa-angle-double-right"></i>
            </button>
          </form>
        </div>
      </div>
