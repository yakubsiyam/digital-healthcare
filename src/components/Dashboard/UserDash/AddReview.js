                        ...
                        <div className="col-lg-9">
                            <div className="my-3 py-2 bg-dark-pro container rounded-10 text-white">
                                <form onSubmit={handleUpdateProfile} className="px-5 pt-3 pb-5 bg-dark-pro rounded-10 shadow-lg text-main">
                                    ...
                                    <div className="my-4">
                                        <label htmlFor="rating" className="form-label">Rate Our Service <span className='text-ss text-white'>( Out of 5 )</span></label>
                                        <input type="number" min="1" max="5" className="form-control" name="rating" required />
                                    </div>
                                    <div className="my-4">
